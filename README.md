...
```bash
yarn add vue3-virtual-keyboard-cn
...
```
import keyboard from "vue3-virtual-keyboard-cn"
Vue.use(keyboard) 然后使用 <vue-virtual-keyboard-cn></vue-virtual-keyboard-cn>;
```

<br/>

### 要想让键盘自动绑定上，input 或 textarea 必须设置 keyboard="true"属性
...
### 词库在本项目的 src/dict 目录下

### 引用词库示例

词库要放在 public/dict 目录下：
